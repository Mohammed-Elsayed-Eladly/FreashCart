...
async function WishList(id){
  ...
  <div className="product">
    ...
    <div className="d-flex py-2">
      {heart == product._id ?<span  onClick={()=>WishList(product._id )} className="ms-auto cursor-pointer" > <i id="wish" className="fa-solid fa-heart text-danger fs-3"></i> </span>
    :<span  onClick={()=>WishList(product._id )} className="ms-auto cursor-pointer" > <i id="wish" className="fa-solid fa-heart fs-3 "></i> </span>
    }
      </div>
